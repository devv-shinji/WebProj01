...
<%
	...
	//파라미터 저장 용도의 Map 컬렉션. String은 키값으로, Object는 밸류값으로.
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-left"><a
										href="BoardView.jsp?num=<%=dto.getIdx()%>&nowPage=<%=nowPage%>&<%=queryStr%>"><%=dto.getTitle()%></a></td>
									<td class="text-center"><%=dto.getId()%></td>
									<td class="text-center"><%=dto.getPost_date()%></td>
