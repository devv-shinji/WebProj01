	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<form action="./join02.jsp" onsubmit="return checkValidate(this);" method="post">
					<p style="text-align:center; margin-bottom:20px;">
					<label><input type="checkbox" name="agreement1" value="1">이용약관과 개인정보취급방침에 동의합니다.</p>
	
					<p style="text-align:center; margin-bottom:20px">
					<input type="image" src="../images/btn01.gif" alt="회원가입">
					<!-- <a href="javascript:checkValidate();"><img src="../images/btn01.gif" /></a> 회원가입버튼 -->
					&nbsp;&nbsp;<a href="javascript:history.go(-1);" ><img src="../images/btn02.gif" /></a> <!-- 취소버튼 -->
					</p>
				
					<script>
						function checkValidate(frm) {
							if(frm.agreement1.checked != true) {
								alert("이용약관에 동의해주세요.");
								return false;
							}
						}
