...
따라서 객체싱성을 위해 new를 사용할 수 없고 유틸리티 메소드를 통해
객체를 생성한다. 
...
/*
년/월 그리고 1일로 설정한다. 즉, 파라미터로 전달된 현재 월의 
1일로 설정함. 
*/
...
//현재 월의 마지막 날짜를 구해온다. (7월->31일, 9월->30일)
...
<body>
   <table cellpadding="0" cellspacing="0" border="1" class="calendar">
      ...
      for (int i=0 ; i< 7; i++){
      %>
         <th style="padding:5px 0;"> <img src="../images/day0<%=i+1 %>.gif" alt="<%=a[i] %>" />
         </th>
      <%
      }
      %>
